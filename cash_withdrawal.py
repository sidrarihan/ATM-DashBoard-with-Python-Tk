...
pin = Text(root, height=1, width = 20)
amount = Text(root, height=1, width=20)
withdraw = Button(root, text="Withdraw", command = wdlclick)
...
withdraw.grid(row=3, column=0, padx=10,pady=10)
